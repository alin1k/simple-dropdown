...
export default function HomePage() {
  return (
    <div className='flex-1 flex flex-col justify-center items-center text-center'>
      ...
      <div className='flex gap-2 p-1 w-1/3'>
        ...
        <Link href={"/docs/dropdown"} className='text-start border rounded-lg px-3 p-2 w-1/2 hover:bg-primary-foreground'>
          <span className='font-bold block mb-2'>Customization <Book className='inline size-3.5 ms-1'/></span>
          See how you can cusomize the dropdown menu
        </Link>
      </div>
    </div>
  )
